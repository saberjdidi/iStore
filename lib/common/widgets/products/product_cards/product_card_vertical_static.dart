...
import 'package:i_store/features/shop/screens/product_details/product_details_static.dart';
...
class TProductCardVerticalStatic extends StatelessWidget {
  const TProductCardVerticalStatic({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () => Get.to(() =>  const ProductDetailsStatic()),
      child: Container(
        width: 180,
